...
export const verbConjugations: VerbConjugation[] = [
  {
    ...
    rows: [
      ...
      { pronoun: "הוא", pronounNikud: "הוּא", pronounEn: "he", form: "רוצה", formNikud: "רוֹצֶה", example: "הוא רוצה לאכול", exampleNikud: "הוּא רוֹצֶה לֶאֱכוֹל", exampleEn: "He wants to eat" },
      { pronoun: "היא", pronounNikud: "הִיא", pronounEn: "she", form: "רוצה", formNikud: "רוֹצָה", example: "היא רוצה לאכול", exampleNikud: "הִיא רוֹצָה לֶאֱכוֹל", exampleEn: "She wants to eat" },
      ...
      { pronoun: "הם", pronounNikud: "הֵם", pronounEn: "they", form: "רוצים", formNikud: "רוֹצִים", example: "הם רוצים לישון", exampleNikud: "הֵם רוֹצִים לִישׁוֹן", exampleEn: "They want to sleep" },
    ],
  },
  {
    word: "צריך",
    ...
    rows: [
      ...
      { pronoun: "הוא", pronounNikud: "הוּא", pronounEn: "he", form: "צריך", formNikud: "צָרִיךְ", example: "הוא צריך ללמוד", exampleNikud: "הוּא צָרִיךְ לִלְמוֹד", exampleEn: "He needs to study" },
      { pronoun: "היא", pronounNikud: "הִיא", pronounEn: "she", form: "צריכה", formNikud: "צְרִיכָה", example: "היא צריכה ללמוד", exampleNikud: "הִיא צְרִיכָה לִלְמוֹד", exampleEn: "She needs to study" },
      ...
      { pronoun: "הם", pronounNikud: "הֵם", pronounEn: "they", form: "צריכים", formNikud: "צְרִיכִים", example: "הם צריכים לעבוד", exampleNikud: "הֵם צְרִיכִים לַעֲבוֹד", exampleEn: "They need to work" },
    ],
  },
  {
    word: "יכול",
    wordEn: "can",
    rows: [
      { pronoun: "אני (זכר)", pronounNikud: "אֲנִי (ז)", pronounEn: "I (m.)", form: "יכול", formNikud: "יָכוֹל", example: "אני יכול לעזור", exampleNikud: "אֲנִי יָכוֹל לַעֲזוֹר", exampleEn: "I can help" },
      { pronoun: "אני (נקבה)", pronounNikud: "אֲנִי (נ)", pronounEn: "I (f.)", form: "יכולה", formNikud: "יְכוֹלָה", example: "אני יכולה לעזור", exampleNikud: "אֲנִי יְכוֹלָה לַעֲזוֹר", exampleEn: "I can help" },
      { pronoun: "הוא", pronounNikud: "הוּא", pronounEn: "he", form: "יכול", formNikud: "יָכוֹל", example: "הוא יכול לקרוא", exampleNikud: "הוּא יָכוֹל לִקְרוֹא", exampleEn: "He can read" },
      { pronoun: "היא", pronounNikud: "הִיא", pronounEn: "she", form: "יכולה", formNikud: "יְכוֹלָה", example: "היא יכולה לקרוא", exampleNikud: "הִיא יְכוֹלָה לִקְרוֹא", exampleEn: "She can read" },
  ...
  },
  {
    ...
    rows: [
      ...
      { pronoun: "הוא", pronounNikud: "הוּא", pronounEn: "he", form: "אוהב", formNikud: "אוֹהֵב", example: "הוא אוהב לקרוא", exampleNikud: "הוּא אוֹהֵב לִקְרוֹא", exampleEn: "He loves to read" },
      { pronoun: "היא", pronounNikud: "הִיא", pronounEn: "she", form: "אוהבת", formNikud: "אוֹהֶבֶת", example: "היא אוהבת לקרוא", exampleNikud: "הִיא אוֹהֶבֶת לִקְרוֹא", exampleEn: "She loves to read" },
